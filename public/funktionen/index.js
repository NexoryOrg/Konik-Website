...
if (loadMapBtn) {
    loadMapBtn.addEventListener("click", function() {
        ...
        if (mapDiv && placeholder) {
            ...
            // Kleine Verzögerung, damit der Container sichtbar ist
            setTimeout(() => {
                ...
                const popup = L.popup({
                    closeButton: true,
                    className: 'map-popup'
                }).setContent('<div style="font-size: 1.1rem; font-weight: 600; color: #2e7d32; text-align: center; padding: 5px;"><b>Nationalparkzentrum Schwarzwald</b><br><span style="font-size: 0.9rem; color: #666;">Bad Liebenzell-Unterreichenbach</span></div>');
                
                L.marker([48.5606575, 8.2220008], {
                    title: 'Nationalparkzentrum Schwarzwald'
                }).addTo(map).bindPopup(popup).openPopup();
                
                // Resize ist wichtig bei versteckten Containern
                map.invalidateSize();
